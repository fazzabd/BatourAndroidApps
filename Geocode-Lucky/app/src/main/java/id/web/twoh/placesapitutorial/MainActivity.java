...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupGoogleAPI();
        setupDialog();
        this.keList = findViewById(R.id.panggil);

        keList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
                Intent intentKeList = new Intent(MainActivity.this, TempatActivity.class);

                TextView latV = findViewById(R.id.latitude);
                TextView lngV = findViewById(R.id.longitude);

                intentKeList.putExtra("Lat", latV.getText());
                intentKeList.putExtra("Long", lngV.getText());

                startActivity(intentKeList);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == RESULT_OK) {
                ...
                latV.setText(String.valueOf(place.getLatLng().latitude));
                lngV.setText(String.valueOf(place.getLatLng().longitude));
            }
        }
    }
